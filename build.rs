...
fn os_build() -> Result<()> {
    ...
    let bindings: Bindings = Builder::default()
        ...
        .allowlist_var("RTE_ETH_RSS_NONFRAG_IPV4_TCP")
        .allowlist_var("RTE_ETH_RSS_NONFRAG_IPV4_UDP")
        .allowlist_var("RTE_ETH_RSS_NONFRAG_IPV6_TCP")
        .allowlist_var("RTE_ETH_RSS_NONFRAG_IPV6_UDP")
